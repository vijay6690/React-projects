...
export default function ProductList() {
  ...
  useEffect(() => {
    // dispatch(fetchALlProductAsynce());
                ...
                <div className="hidden sm:flex sm:flex-1 sm:items-center sm:justify-between">
                  <div>
                    <p className="text-sm text-gray-700">
                      ...
                      <span className="font-medium">{totalItems-1}</span> results
                    </p>
                  </div>
                  <div>
                    <nav
                    ...
                    >
                      ...
                      <div
                      onClick={(e)=> hanldePage(page < totalPages ? page + 1 : page)}
